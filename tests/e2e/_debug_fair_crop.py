"""Debug-only: recompute the visual-overlay mismatch for FIXTURE_A with
...
_source_table_rect unchanged, since it already has zero padding. Does
NOT modify test_visual_overlay.py. Run with python3, not pytest."""
import sys
import tempfile
...
with tempfile.TemporaryDirectory() as td:
    ...
    img_source = _render_crop(fitz, FIXTURE_A, 0, src_rect)
...
combo.save(OUT_DIR / "fixture_a_fair_crop.png")
print("saved ->", OUT_DIR / "fixture_a_fair_crop.png")
