"""Debug-only: per-row vertical fraction drift for FIXTURE_A using the
...
with tempfile.TemporaryDirectory() as td:
    ...
    sp = sd[0]
    print(f"{'row':<4}{'anchor':<12}{'src_frac':>10}{'out_frac':>10}{'diff':>10}")
    for i, row in enumerate(table.grid):
        ...
        if sr and orr:
            ...
            print(f"{i:<4}{best_text:<12}{sf:>10.3f}{of:>10.3f}{of - sf:>10.3f}")

    # Also horizontal, real data-row anchors across the width, using the
    # fair (no padding) out_rect this time.
    print()
    print("Horizontal (fair crop):")
    anchors = ["00000001", "00001010", "10000000", "01111111", "00011111", "11111111"]
    for a in anchors:
        ...
        if sr and orr:
            ...
            print(f"{a:<12}{sf:>10.3f}{of:>10.3f}{of - sf:>10.3f}")
